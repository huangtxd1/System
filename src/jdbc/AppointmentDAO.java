...
public class AppointmentDAO implements ADAO{
    ...
    public void delete(String userName, House house) {
        ...
        String sql = "delete from appointment where username = ? and houseid = ?";
        try (Connection c = getConnection(); PreparedStatement ps = c.prepareStatement(sql);) {
    ...
    public void delete(House house){
        ...
        String sql = "delete from appointment where houseid = ?";
        try (Connection c = getConnection(); PreparedStatement ps = c.prepareStatement(sql);) {
    ...
    public boolean isAppointment(String userName, House house) {
        ...
        String sql = "select * from appointment where username = ? and houseid = ?";
        try(Connection c = getConnection(); PreparedStatement ps = c.prepareStatement(sql);){
    ...
    public String appointmentMan(House house) {
        ...
        String sql = "select * from appointment where houseid = ?";
        try(Connection c = getConnection(); PreparedStatement ps = c.prepareStatement(sql);){
